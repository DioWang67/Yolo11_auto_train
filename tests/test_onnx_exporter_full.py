...
class TestOnnxExporterExport:
    ...
    def test_returns_none_when_onnx_file_not_found_after_export(self, tmp_path, monkeypatch):
    ...
    def test_validates_onnx_after_export(self, tmp_path, monkeypatch):
        ...
        mock_yolo_class = MagicMock(return_value=mock_model)
        monkeypatch.setattr("picture_tool.utils.onnx_exporter.YOLO", mock_yolo_class)
        monkeypatch.setattr("picture_tool.utils.onnx_exporter.validate_onnx_structure", mock_structure)
        monkeypatch.setattr("picture_tool.utils.onnx_exporter.validate_onnx_runtime", mock_runtime)
    ...
    def test_returns_none_when_validation_fails(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("picture_tool.utils.onnx_exporter.validate_onnx_structure", fail_validation)
